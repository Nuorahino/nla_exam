...
extern "C" {
extern int ssteqr_(char*,               // Compz: "N" no eigenvalues
                   int*,                // N: order of the Matrix
                   float*,              // D: double precision array of diagonal entries
                   float*,              // E: double precision array of subdiagonal entries
                   float*,              // Z: double preciosion array when no eigenvalues are computed of size n
                   int*,                // LDZ: without eigenvalues 1
                   float*,              // WORK: double precision array with Compz = N unreferenzed
                   int*);               // INFO: Output
}
